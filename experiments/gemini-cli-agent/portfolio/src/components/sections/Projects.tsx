...
import { CloudSun, Coins, Languages, Mail, Utensils, ExternalLink, Cpu, Sparkles, Workflow } from "lucide-react";
...
const projects = [
  ...
  },
  {
    ...
    description: "Visualize code logic instantly.",
    icon: <Workflow className="text-pink-400" size={24} />,
