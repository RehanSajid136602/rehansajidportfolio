...
- [ ] Structural Preservation: No changes to layout, structure, spacing, or content.
- [ ] Visual Skin Isolation: Only style/theme changes (colors, tokens, shadows, borders, typography).
...
- [ ] Clear Justification: Any exceptions are documented and justified.
